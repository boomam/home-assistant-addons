# Unofficial Home Assistant Add-ons: Newt

Newt bundled as an Home Assistant add-on.
...
[Click here for the full Newt documentation](https://docs.pangolin.net/manage/sites/understanding-sites)  
